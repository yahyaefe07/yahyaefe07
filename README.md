...
## Batch Scripting
I have built multiple batch files in the past to; make simple tasks like moving files, copying files etc. I have also built them for things like fixing issues with some apps, and for automation like installing apps.

## Python
I have built a lot of python scripts in the past. I have built an message encryptor, and a small game.
